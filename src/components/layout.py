...
from ..config.settings import APP_TITLE, APP_SUBTITLE, DEFAULT_WINDOW_START, DEFAULT_WINDOW_END, DEFAULT_FS, DEFAULT_SPEC_WIN_SEC, DEFAULT_SPEC_OVERLAP, DEFAULT_HR_MIN, DEFAULT_HR_MAX, DEFAULT_PEAK_PROM_FACTOR, DEFAULT_DECIM_USER
